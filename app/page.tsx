  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#060B27] text-white">
        ...
        <div className="flex items-center gap-4">
          {!isSignedIn && (
            <>
              ...
              <Link
                href="/sign-up"
                className="px-4 py-2 rounded-lg text-sm font-medium bg-linear-to-r from-[#6A5CFF] to-[#9D4EDD]"
              >
                Get Started
              </Link>
            </>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-300 max-w-xl mt-6 text-lg md:text-xl leading-relaxed">
              Get instant ATS score, skill extraction, formatting analysis, and
              actionable improvement suggestions powered by advanced AI.
            </p>
      ...
      <section className="relative z-20 mt-28 px-6 max-w-4xl mx-auto space-y-6">
        {/* Card 1 */}
        <div
          className="feature-fade bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl 
      ...
      <section className="relative z-20 mt-32 px-6 max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          {/* Testimonial 1 */}
          <div
            className="feature-fade bg-white/5 border border-white/10 rounded-2xl p-6 
          ...
          >
            ...
            <p className="text-gray-200 text-lg leading-relaxed mb-4">
              &quot;ResumeLens AI helped me boost my ATS score from 45% to 82%.
              Landed my dream job!&quot;
            </p>
            <div>
          ...
          >
            ...
            <p className="text-gray-200 text-lg leading-relaxed mb-4">
              &quot;The skill extraction was incredibly accurate. Saved me hours
              of manual work.&quot;
            </p>
            <div>
          ...
          >
            ...
            <p className="text-gray-200 text-lg leading-relaxed mb-4">
              &quot;Best investment for job hunting. The recommendations are
              spot-on!&quot;
            </p>
            <div>
      ...
      <section className="relative z-20 mt-32 px-6 max-w-4xl mx-auto text-center">
        ...
        <p className="text-gray-300 max-w-xl mx-auto mb-8 text-lg">
          Join thousands of professionals using ResumeLens to land their dream
          jobs.
        </p>
